...
final class ArchitectureTests: XCTestCase {
    ...
    func testBranchPickerViewModelFiltering() async {
        ...
        appState.localBranchSummaries = [
            LocalBranchSummary(branch: "main", isCurrent: false, isDirty: false, aheadCount: 0, behindCount: 0, upstream: "origin/main", relatedPRNumber: nil, relatedPRTitle: nil, lastAuthor: "Alice", lastUpdated: "2 days ago"),
            LocalBranchSummary(branch: "feature/mvvm", isCurrent: true, isDirty: true, aheadCount: 2, behindCount: 0, upstream: "origin/feature/mvvm", relatedPRNumber: 42, relatedPRTitle: "Harden app architecture", lastAuthor: "Rohan", lastUpdated: "5 mins ago"),
            LocalBranchSummary(branch: "feature/ast", isCurrent: false, isDirty: false, aheadCount: 0, behindCount: 1, upstream: "origin/feature/ast", relatedPRNumber: nil, relatedPRTitle: nil, lastAuthor: "Bob", lastUpdated: "1 day ago")
        ]
    ...
    func testCommitScopeViewModelTimelineCycling() async {
        ...
        appState.commits = [
            ...
            GitCommit(sha: "sha3", author: "Rohan", subject: "Refactor architecture", date: "May 25")
        ]
    ...
    func testAnalysisViewModelTriageAndBucketSelection() async {
        ...
        let pr = PullRequest(prNumber: 5, title: "Hardening test", baseSha: "base", headSha: "head", author: "Rohan", repository: "test")
        
        let files = [
            ChangedFile(analysisRunId: run.id, path: "App.swift", status: .modified, additions: 10, deletions: 5, classification: .source, hunks: []),
            ChangedFile(analysisRunId: run.id, path: "AppTests.swift", status: .added, additions: 20, deletions: 0, classification: .test, hunks: []),
            ChangedFile(analysisRunId: run.id, path: "README.md", status: .modified, additions: 5, deletions: 0, classification: .documentation, hunks: [])
        ]
        
        let buckets = [
            ChangeBucket(id: "behavior", type: .behavior, title: "Behavior Changes", summary: "Production core edits", files: ["App.swift"], symbols: [], riskLevel: .medium, riskReasons: [], evidence: [], reviewOrder: 1),
            ChangeBucket(id: "tests", type: .tests, title: "Tests Changes", summary: "Unit tests edits", files: ["AppTests.swift"], symbols: [], riskLevel: .low, riskReasons: [], evidence: [], reviewOrder: 2)
        ]
        
        let targets = [
            ReviewTarget(id: UUID(), priority: 10, severity: .medium, title: "Test Target", filePath: "App.swift", reason: "Critical logic modified", evidence: "", source: "Deterministic Rules")
        ]
